...
public class JdbcTemplateTest {
    ...
    public void mainTest() {
        // 加载配置文件
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("applicationxm1.xml");
        // 获取JdbcTemplate实例
    ...
    public void addAccountTest() {
        ...
        account.setUsername("Lhf");
        account.setBalance(900.00);
    ...
    public void updateAccountTest() {
        ...
        ApplicationContext applicationContext =
                new ClassPathXmlApplicationContext("applicationxm1.xml");
        // 获取AccountDao实例
        ...
        account.setBalance((double) 3000);
